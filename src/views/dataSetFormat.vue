          ...
          children: [
            {
              ...
              key:'"description"',
              value: '"ImageNet is an image database organized according to the WordNet hierarchy (currently only the nouns), in which each node of the hierarchy is depicted by hundreds and thousands of images [...] The data is available for free to researchers for non-commercial use."',
              tip:
              ...
              value: '"We collect candidate images from the Internet by querying several image search engines."',
              tip:
